...
<style>
    ...
    .lightbox-content img {
        width: auto;
        height: 80vh; /* Maksimal tinggi gambar */
        max-width: 100%;
    }
    .close {
        position: absolute;
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <embed src="{{ asset('storage/' . $aset->berkas_shp) }}" type="application/pdf" width="100%" height="600px" />
                                @else
                                NULL
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <embed src="{{ asset('storage/' . $aset->berkas_pks) }}" type="application/pdf" width="100%" height="600px" />
                                @else
                                NULL
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('storage/' . $aset->foto_npwp) }}" alt="Foto NPWP" style="max-width: 100px; height: auto; cursor: pointer;" onclick="openLightbox('{{ asset('storage/' . $aset->foto_npwp) }}')">
                                @else
                                NULL
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('storage/' . $aset->foto_ktp) }}" alt="Foto KTP" style="max-width: 100px; height: auto; cursor: pointer;" onclick="openLightbox('{{ asset('storage/' . $aset->foto_ktp) }}')">
                                @else
                                NULL
                                @endif
                            </td>
